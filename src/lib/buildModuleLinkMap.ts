...
const MODULE_FIELDS: Record<string, { field: string; nameKey: string }> = {
  ...
  tomodachiLifeMarriageGuide: { field: 'steps', nameKey: 'name' },
  tomodachiLifeBabyGuide: { field: 'steps', nameKey: 'name' },
  ...
  tomodachiLifeImportWear: { field: 'items', nameKey: 'topic' },
  tomodachiLifeConcertHall: { field: 'items', nameKey: 'heading' },
  tomodachiLifeVoiceCatchphrases: { field: 'items', nameKey: 'title' },
