...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.tomodachilife.wiki'
  const path = '/about'

  return {
    title: 'About Tomodachi Life Wiki - Your Ultimate Nintendo Game Resource',
    description: 'Learn about Tomodachi Life Wiki, a community-driven resource hub providing comprehensive guides, crafting tips, creature info, and strategies for the Tomodachi Life Nintendo game.',
    keywords: [
      'about Tomodachi Life Wiki',
    ...
    openGraph: {
      ...
      siteName: 'Tomodachi Life Wiki',
      title: 'About Tomodachi Life Wiki',
      description: 'Learn about our mission to provide the best Tomodachi Life game resources and guides.',
      images: [
        {
          url: `${siteUrl}/og-image.jpg`,
          width: 1200,
          height: 630,
          alt: 'Tomodachi Life Wiki',
        },
      ],
    },
    twitter: {
      ...
      title: 'About Tomodachi Life Wiki',
      description: 'Learn about our mission to provide the best Tomodachi Life game resources.',
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Your community-driven resource center for Tomodachi Life
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Welcome to Tomodachi Life Wiki</h2>
            <p>
              Tomodachi Life Wiki is an <strong>unofficial, fan-made resource website</strong> dedicated to helping players
              master the Nintendo game "Tomodachi Life". We are a community-driven platform that provides comprehensive guides,
            ...
            <p>
              ...
              Tomodachi Life Wiki is here to support you every step of the way.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            <h2>Our Mission</h2>
            <p>
              Our mission is simple: <strong>to empower Tomodachi Life players with accurate, up-to-date information
            ...
            <h2>Our Vision</h2>
            <p>
              We envision Tomodachi Life Wiki as the <strong>go-to destination</strong> for every Tomodachi Life player seeking
      ...
      <section className="py-12 px-4 bg-slate-900/30">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Tomodachi Life Wiki is built <strong>by the community, for the community</strong>. We welcome contributions,
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              Tomodachi Life Wiki is maintained by a dedicated team of passionate gamers and developers who love
              Tomodachi Life as much as you do. We're players first, constantly testing strategies, exploring game
            ...
            <ul>
              <li><strong>Game analysis:</strong> Deep understanding of Tomodachi Life mechanics and strategies</li>
        ...
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p className="text-yellow-400/90">
              <strong>Tomodachi Life Wiki is an unofficial fan-made website.</strong> We are NOT affiliated with,
              endorsed by, or associated with the developers of Tomodachi Life or any official entities.
            </p>
            <p>
            ...
            <p>
              Tomodachi Life Wiki is a non-profit, community resource created by fans, for fans.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <div className="not-prose grid md:grid-cols-2 gap-4 my-6">
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                ...
                <a href="mailto:contact@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contact@tomodachilife.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Bug Reports</h3>
                <a href="mailto:support@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  support@tomodachilife.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Content Submissions</h3>
                <a href="mailto:contribute@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  contribute@tomodachilife.wiki
                </a>
              </div>
              <div className="p-4 rounded-lg bg-slate-900/50 border border-slate-800">
                <h3 className="text-lg font-semibold text-white mb-2">Partnerships</h3>
                <a href="mailto:partnerships@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">
                  partnerships@tomodachilife.wiki
                </a>
              </div>
            </div>
      ...
      <section className="py-12 px-4 bg-gradient-to-r from-purple-900/30 to-blue-900/30 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 mb-6 max-w-2xl mx-auto">
            Stay updated with the latest guides, tips, and Tomodachi Life news.
