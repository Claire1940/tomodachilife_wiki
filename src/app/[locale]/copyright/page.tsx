...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Tomodachi Life Wiki',
    description: 'Copyright and intellectual property information for Tomodachi Life Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Tomodachi Life Wiki copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Tomodachi Life Wiki',
      description: 'Copyright and intellectual property information for Tomodachi Life Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Tomodachi Life Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Tomodachi Life Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Tomodachi Life Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Nintendo</strong> - Owner of the Nintendo platform</li>
              <li><strong>Tomodachi Life Developers</strong> - Creators of the Tomodachi Life game</li>
            </ul>
            <p>
            ...
            <ul>
              <li><strong>NINTENDO</strong> - Trademark of Nintendo Co., Ltd.</li>
              <li><strong>Tomodachi Life</strong> - Trademark of the game developers</li>
              <li><strong>Tomodachi Life Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Tomodachi Life Wiki.
            </p>
            ...
            <p>
              ...
              Tomodachi Life Wiki<br />
              Email: <a href="mailto:dmca@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@tomodachilife.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Tomodachi Life Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Tomodachi Life Wiki (tomodachilife.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@tomodachilife.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@tomodachilife.wiki</a>
            </p>
            <p>
