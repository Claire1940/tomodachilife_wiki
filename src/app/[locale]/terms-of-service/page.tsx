...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Tomodachi Life Wiki",
    description: "Read the Terms of Service for Tomodachi Life Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Nintendo game resource platform.",
    keywords: [
      'terms of service',
      "Tomodachi Life Wiki terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Tomodachi Life Wiki",
      description: "Terms and conditions for using Tomodachi Life Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Tomodachi Life Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Tomodachi Life Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Tomodachi Life Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Tomodachi Life Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Nintendo Switch game "Tomodachi Life". Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Tomodachi Life Wiki is NOT affiliated with, endorsed by, or associated with
              Nintendo or HAL Laboratory. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Tomodachi Life Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Nintendo and/or HAL Laboratory. We use such
            ...
            <ul>
              ...
              <li><strong>Demo Availability:</strong> Nintendo demo availability and game updates may change without notice. We are not responsible for demo access or game changes.</li>
            </ul>
            <p>
            ...
            <p>
              The Website may contain links to third-party websites, including Nintendo, Reddit, social media platforms,
            ...
            <p>
              ...
              you and Tomodachi Life Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@tomodachilife.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@tomodachilife.wiki</a>
            </p>
            <p>
