    ...
    '@graph': [
      {
        ...
        '@id': `${siteUrl}/#website`,
        url: siteUrl,
        name: "Tomodachi Life Wiki",
        description: "Complete Tomodachi Life Wiki covering Mii creation, personalities, QR codes, relationships, island life, food, interiors, and Living the Dream guides.",
        image: {
          '@type': 'ImageObject',
          url: `${siteUrl}/images/hero.webp`,
          width: 1920,
          height: 1080,
          caption: "Tomodachi Life - Quirky Mii Life Simulator for Nintendo Switch",
        },
        potentialAction: {
          '@type': 'SearchAction',
      ...
      },
      {
        ...
        name: "Tomodachi Life Wiki",
        alternateName: "Tomodachi Life",
        url: siteUrl,
        description: "Complete Tomodachi Life Wiki resource hub for Mii personalities, QR codes, relationships, locations, food, interiors, and island life guides",
        logo: {
          '@type': 'ImageObject',
      ...
      },
      {
        ...
        genre: ['Life Simulation', 'Social Simulation', 'Casual'],
        numberOfPlayers: {
          minValue: 1,
          maxValue: 2,
        },
      ...
      <section className="px-4 py-12">
        <div className="scroll-reveal container mx-auto">
          <div className="relative rounded-2xl overflow-hidden">
            <VideoFeature
              videoId="_xY0XuGOWJs"
              title="Tomodachi Life: Living the Dream – Overview Trailer"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a
                    href="https://gamefaqs.gamespot.com/boards/643013-tomodachi-life"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
                ...
                <li>
                  <a
                    href="https://www.nintendo.com/en-gb/Games/Nintendo-Switch-download-software/Tomodachi-Life-Living-the-Dream-2786386.html"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-[hsl(var(--nav-theme-light))] transition"
                  >
